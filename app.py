...
if prompt:
    cur.execute(
        "INSERT INTO prompts (title, prompt) VALUES (%s, %s)", (prompt.title, prompt.prompt,)
    )
    con.commit()
...
"""
prompts = [
    (1,"title1","title2",True,),-> p[0] -> id, p[1] -> "title",p[2] ->"prompt1"
    (2,"title1","title2",True,)
    (3,"title1","title2",True,)
]
"""
